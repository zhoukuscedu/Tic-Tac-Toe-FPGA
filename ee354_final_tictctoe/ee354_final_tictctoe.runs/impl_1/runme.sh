...
HD_PWD='C:/Xilinx_Projects/Final/ee354_final_tictctoe/ee354_final_tictctoe.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log tictactoe_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source tictactoe_top.tcl -notrace
