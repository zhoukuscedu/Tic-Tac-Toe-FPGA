...
HD_PWD='C:/Xilinx_Projects/Final/ee354_final_tictctoe/ee354_final_tictctoe.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log tictactoe_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source tictactoe_top.tcl
